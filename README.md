...
or process your samples to have only in filename "midinote.WAV" "WAV" not "wav" in renemer program "krename" for example ,it can be easly done.. the use tool (./tool/nametonote.py to convert midiNoteName.WAV to midiNumber.wav

>>
cp /tool/nametonote.py to /path/with/samples
