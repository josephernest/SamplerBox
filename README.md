...
You need a RaspberryPi 2 (untested on RaspberryPi B / B+) and a DAC (such as [this 6€ one](http://www.ebay.fr/itm/1Pc-PCM2704-5V-Mini-USB-Alimente-Sound-Carte-DAC-decodeur-Board-pr-ordinateur-PC-/231334667385?pt=LH_DefaultDomain_71&hash=item35dc9ee479) that provides really high-quality sound ; please note that without any DAC, the RaspberryPi's built-in soundcard would produce very bad sound quality and lag).

1. Assuming you are using a Raspbian distribution, you can install the required dependecies (Python-related packages and audio libraries) this way:
